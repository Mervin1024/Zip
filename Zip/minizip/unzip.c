...
local unzFile m_unzOpenInternal(const void *path, zlib_filefunc64_32_def* pzlib_filefunc64_32_def)
{
    unz64_s us;
    unz64_s *s;
    ...
    {
        *s = us;
        m_unzGoToFirstFile((unzFile)s);
    }
    return (unzFile)s;
}

extern unzFile ZEXPORT m_unzOpen2(const char *path, zlib_filefunc_def* pzlib_filefunc32_def)
{
    if (pzlib_filefunc32_def != NULL)
    {
        zlib_filefunc64_32_def zlib_filefunc64_32_def_fill;
        fill_zlib_filefunc64_32_def_from_filefunc32(&zlib_filefunc64_32_def_fill, pzlib_filefunc32_def);
        return m_unzOpenInternal(path, &zlib_filefunc64_32_def_fill);
    }
    return m_unzOpenInternal(path, NULL);
}

extern unzFile ZEXPORT m_unzOpen2_64(const void *path, zlib_filefunc64_def* pzlib_filefunc_def)
{
...
extern unzFile ZEXPORT m_unzOpen(const char *path)
{
    return m_unzOpenInternal(path, NULL);
}

extern unzFile ZEXPORT m_unzOpen64(const void *path)
{
    return m_unzOpenInternal(path, NULL);
}

extern int ZEXPORT m_unzClose(unzFile file)
{
    unz64_s* s;
    if (file == NULL)
...
extern int ZEXPORT m_unzGetGlobalInfo(unzFile file, unz_global_info* pglobal_info32)
{
    unz64_s* s;
    if (file == NULL)
        return UNZ_PARAMERROR;
...
extern int ZEXPORT m_unzGetGlobalInfo64(unzFile file, unz_global_info64* pglobal_info)
{
    unz64_s* s;
    if (file == NULL)
        return UNZ_PARAMERROR;
...
extern int ZEXPORT m_unzGetCurrentFileInfo(unzFile file, unz_file_info * pfile_info, char *filename,
...
extern int ZEXPORT m_unzGetCurrentFileInfo64(unzFile file, unz_file_info64 * pfile_info, char *filename,
    uLong filename_size, void *extrafield, uLong extrafield_size, char* comment,  uLong comment_size)
{
...
*/
extern int ZEXPORT m_unzOpenCurrentFile3(unzFile file, int* method, int* level, int raw, const char* password)
{
    int err = UNZ_OK;
...
extern int ZEXPORT m_unzOpenCurrentFile(unzFile file)
{
    return m_unzOpenCurrentFile3(file, NULL, NULL, 0, NULL);
}

extern int ZEXPORT m_unzOpenCurrentFilePassword(unzFile file, const char* password)
{
    return m_unzOpenCurrentFile3(file, NULL, NULL, 0, password);
}

extern int ZEXPORT m_unzOpenCurrentFile2(unzFile file, int* method, int* level, int raw)
{
    return m_unzOpenCurrentFile3(file, method, level, raw, NULL);
}
...
extern int ZEXPORT m_unzReadCurrentFile(unzFile file, voidp buf, unsigned len)
{
    int err = UNZ_OK;
    uInt read = 0;
    unz64_s* s;
...
extern int ZEXPORT m_unzCloseCurrentFile(unzFile file)
{
    int err = UNZ_OK;
...
extern int ZEXPORT m_unzGoToFirstFile2(unzFile file, unz_file_info64 *pfile_info, char *filename,
    uLong filename_size, void *extrafield, uLong extrafield_size, char *comment, uLong comment_size)
{
    int err = UNZ_OK;
    unz64_s* s;
...
extern int ZEXPORT m_unzGoToFirstFile(unzFile file)
{
    return m_unzGoToFirstFile2(file, NULL, NULL, 0, NULL, 0, NULL, 0);
}

extern int ZEXPORT m_unzGoToNextFile2(unzFile file, unz_file_info64 *pfile_info, char *filename,
    uLong filename_size, void *extrafield, uLong extrafield_size, char *comment, uLong comment_size)
{
    unz64_s* s;
    int err;
...
extern int ZEXPORT m_unzGoToNextFile(unzFile file)
{
    return m_unzGoToNextFile2(file, NULL, NULL, 0, NULL, 0, NULL, 0);
}
...
extern int ZEXPORT unzLocateFile(unzFile file, const char *filename, unzFileNameComparer filename_compare_func)
{
    ...
    err = m_unzGoToFirstFile2(file, NULL, current_filename, sizeof(current_filename)-1, NULL, 0, NULL, 0);
    ...
    while (err == UNZ_OK)
    {
        ...
        if (err == 0)
            return UNZ_OK;
        err = m_unzGoToNextFile2(file, NULL, current_filename, sizeof(current_filename)-1, NULL, 0, NULL, 0);
    }
